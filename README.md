...
We studied several classical ML algorithms for classification between Star-Galaxy and Star-Galaxy-Quasar using photometric features alone. The files can be found at **[MLAlgos](./MLAlgos)**.
